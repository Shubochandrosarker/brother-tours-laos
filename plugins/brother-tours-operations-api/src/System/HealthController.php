...
final class HealthController {
	...
	public function routes():void{register_rest_route(BTOA_NAMESPACE,'/system/health',array('methods'=>'GET','callback'=>array($this,'get'),'permission_callback'=>static fn(WP_REST_Request $r)=>Csrf::authorize($r,'edit_posts',false)));}
