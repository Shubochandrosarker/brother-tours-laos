...
final class ContentSeeder {
	...
	private function tours(): array {
		...
		$tours = array(
			...
			array( 'slug' => '3-day-immersive-local-life-experience', 'title' => '3 Day Local Life Experience', 'duration' => '3 days', 'destinations' => array( 'luang-prabang', 'nong-khiaw' ), 'regions' => array( 'Northern Laos' ), 'styles' => array( 'Culture', 'Local Life' ), 'accent' => 'Local Life', 'excerpt' => 'A three-day local life program designed around village visits, food, craft, local transport, and slow cultural exchange.', 'itinerary' => 'Spend three days with guided local experiences, village or family-hosted activities, markets, meals, and short scenic transfers.' ),
			...
			array( 'slug' => 'lao-immersion-two-weeks-of-adventure-and-cultural-exchange', 'title' => 'Lao Immersion: Two Weeks of Adventure and Cultural Exchange', 'duration' => '2 weeks', 'destinations' => array( 'vientiane', 'luang-prabang', 'vang-vieng', 'nong-khiaw' ), 'regions' => array( 'Northern Laos', 'Central Laos' ), 'styles' => array( 'Adventure', 'Cultural Exchange' ), 'accent' => 'Immersion', 'excerpt' => 'A two-week Laos program combining adventure, cultural exchange, local learning, and flexible private routing.', 'itinerary' => 'Use two weeks for a balanced route through Vientiane, Vang Vieng, Luang Prabang, and northern scenery with community-focused activities.' ),
