<?php
/**
 * The four Brother Tours forms, as editable Formistic form definitions.
 *
...
final class Wpistic_Formistic_BT_Forms {
	...
	public static function slugs() {
		return [ self::BUILD_MY_TRIP, self::CONTACT, self::NEWSLETTER, self::TRAVEL_AGENT ];
	}
	...
	public static function ingested_slugs() {
		return [ self::BUILD_MY_TRIP, self::CONTACT, self::TRAVEL_AGENT ];
	}
