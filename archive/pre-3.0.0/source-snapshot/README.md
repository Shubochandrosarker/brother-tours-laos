...
plugins/
  ...
  brother-tours-content-studio/ structured content, editing, migration and SEO controls
...
rsync -a plugins/brother-tours-content-studio /path/to/wp-content/plugins/
```
